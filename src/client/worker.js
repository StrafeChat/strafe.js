...
var WebsocketWorkerClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.emit("error", {
                            code: 503,
                            message: "Looks like the Strafe API is down. Please try reconnecting later.",
                        });
                        throw new Error("Looks like ".concat(apiUrl + "/gateway", " might be down!"));
    ...
    WebsocketWorkerClient.prototype.reconnect = function () {
        ...
        this.stopHeartbeat();
        this.ws = null;
        setTimeout(function () { return _this.connect(_this.apiUrl, _this.token); }, 5000);
    };
