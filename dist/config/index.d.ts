 ...
 */
export declare const EQUINOX = "http://localhost:4000/v1";
/**
 * The default URL that will be used for the CDN.
 */
export declare const NEBULA = "http://localhost:4001";
/**
 * The default URL that will be used for the WS connection.
 */
export declare const STARGATE = "ws://localhost:8080/events?format=msgpack";
/**
 ...
 */
export declare const STATUS = "online";
/**
