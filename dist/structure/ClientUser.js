...
var ClientUser = /** @class */ (function (_super) {
    ...
    ClientUser.prototype.setPresence = function (presence) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.ws.send({ op: config_1.OpCodes.PRESENCE, data: presence })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ClientUser.prototype.edit = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(this.client.config.equinox, "/users/@me"), {
                            method: "PATCH",
                            headers: {
