...
var SpaceManager = /** @class */ (function (_super) {
    __extends(SpaceManager, _super);
     ...
     */
    SpaceManager.prototype.fetch = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var cached, res, data, space;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.client.config.equinox, "/spaces/").concat(id), {
                                headers: {
                                    "Content-Type": "application/json",
                                    "Authorization": "".concat(this.client.token)
                                }
                            })];
                    case 1:
                        res = _a.sent();
